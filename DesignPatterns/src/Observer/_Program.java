...
public class _Program {
	...
	/*
	 * Observador es un patrón de diseño de software 
	 * que define una dependencia del tipo uno a muchos 
	 * entre objetos, de manera que cuando uno de 
	 * los objetos cambia su estado, notifica este 
